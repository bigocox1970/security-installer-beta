...
function UserPostsSettings() {
  ...
  const fetchCategoriesAndTags = async () => {
    try {
      ...
      console.error('Error fetching user posts settings:', err);
      setError('Failed to load user posts settings');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Post Tags</h3>
        <div className="grid gap-6 md:grid-cols-2">
          <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
